...
class Net(Method) :
  ...
  def generator(self,X1,X2,X3,X4) :
    ...
    # input M
    gen_conv2_1_1, gen_mconv2_1_1 = self.pconv(X2,X4,relu_num,[6,4,4],'relu',relu_int_he,[1,1,1],'same')
    gen_conv2_1_2, gen_mconv2_1_2 = self.pconv(X2,X4,tanh_num,[6,4,4],'tanh',tanh_int_gl,[1,1,1],'same')
    ...
    # input M
    gen_conv2_2_1, gen_mconv2_2_1 = self.pconv(gen_cat2_1,gen_mcat2_1,relu_num*2,[6,4,4],'relu',relu_int_he,[1,1,1],'same')
    ...
    gen_conv2_2_2, gen_mconv2_2_2 = self.pconv(gen_cat2_1,gen_mcat2_1,tanh_num*2,[6,4,4],'tanh',tanh_int_gl,[1,1,1],'same')
    ...
    # input M 
    gen_conv2_3_1,gen_mconv2_3_1 = self.pconv(gen_cat2_2,gen_mcat2_2,relu_num*4,[3,3,3],'relu',relu_int_he,[1,1,1],'same')
    ...
    gen_conv2_3_2 ,gen_mconv2_3_2 = self.pconv(gen_cat2_2,gen_mcat2_2,tanh_num*4,[3,3,3],'tanh',tanh_int_gl,[1,1,1],'same')
    ...
    # residual input M
    gen_resnet_block2 = self.pconv_re_block(X2,X4,(relu_num+tanh_num)*4,[4,4,4],'relu',relu_int_he,[4,4,1],'same')
